                                                ...
                                                @foreach($vendors as $vendor)
                                                    <tr>
                                                        ...
                                                        <td><img style="width: 150px; height: 100px;"
                                                                 src="{{asset($vendor ->logo_image)}}"></td>

                                                        <td>{{$vendor->mobile}}</td>
                                                        <td> {{$vendor->main_category -> name}}</td>

                                                        <td> {{$vendor->active?'مفعل':'غير مفعل'}}</td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('vendors.status',$vendor->id)}}"
                                                                   class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">{{$vendor->active?'تعطيل':'تفعيل'}}</a>
