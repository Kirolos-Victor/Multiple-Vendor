                                        ...
                                        <form class="form" action="{{route('vendors.update',$vendor -> id)}}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label id="projectinput7" class="file center-block">
                                                    <input type="file" id="file" name="logo_image">
                                                    ...
                                                    <div class="class col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" id="password"
                                                                   class="form-control"
                                                                   placeholder="Dont enter again if you dont want to change!" name="password"
                                                            >
...
<!-- fe moshkla fl address msh byzahr fl update -->
