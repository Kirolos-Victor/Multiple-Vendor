                                        ...
                                        <table
                                            ...
                                            @isset($categories)
                                                @foreach($categories as $category)
                                                    <tr>
                                                        <td>{{$category -> name}}</td>
                                                        <td>{{\Illuminate\Support\Facades\Config::get('app.locale')}}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('main_categories.status',$category->id)}}"
                                                                   class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">{{$category->active?'تعطيل':'تفعيل'}}</a>
